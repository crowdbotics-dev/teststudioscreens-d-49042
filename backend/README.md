...
## Project Structure
    ...
    ├── teststudioscreens_d_49042  # Django project configurations
...
1. Clone this repo and `cd teststudioscreens_d_49042`
...
2. Clone this repo and `cd teststudioscreens_d_49042`
